...
const About = () => {
  return (
    ...
    container mx-auto p-14 md:px-20 lg:-32 w-full overflow-hidden' id='About'>
      ...
      <p className='text-gray max-w-80 text-center mb-8'>Passionate About Properties, 
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                ...
                <p className='my-10 max-w-lg'>lorem Ipsum is simply dummy text of the printing and type setting
