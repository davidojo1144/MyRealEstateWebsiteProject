    ...
    overflow-hidden ' id='Footer'>
        ...
        justify-between items-start'>
            ...
            <div className='w-full md:w-1/3'>
                ...
                <p className='text-gray-400 max-w-80'>The latest news, articles, and resources, 
                    sent to our inbox weekly.</p>
        ...
        text-gray-500'>
        Copyright 2024 &copy; OptimizeDave, All Right Reserved.
        </div>
    </div>
  )
}
